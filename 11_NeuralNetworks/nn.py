...
if __name__ == '__main__':
    ...
    n_iter = int(input('number of iteration: '))
    for i in range(n_iter):
        nn.train(training_inputs=in_val, training_outputs=out_val)
    print(n_iter, '- E_tot:', round(nn.calculate_total_error([[in_val, out_val]]), 9))
